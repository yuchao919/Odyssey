...
﻿using Abp.Owin;
using MyAbpMultiPageApp.Api.Controllers;
using MyAbpMultiPageApp.Web;
...
namespace MyAbpMultiPageApp.Web
{
    public class Startup
    {
        public void Configuration(IAppBuilder app)
        {
            ...
            //ENABLE TO USE HANGFIRE dashboard (Requires enabling Hangfire in MyAbpMultiPageAppWebModule)
