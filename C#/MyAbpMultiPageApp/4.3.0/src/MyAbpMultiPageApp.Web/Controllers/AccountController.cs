...
using MyAbpMultiPageApp.Sessions;
using MyAbpMultiPageApp.Web.Controllers.Results;
using MyAbpMultiPageApp.Web.Models;
using MyAbpMultiPageApp.Web.Models.Account;
...
{
    public class AccountController : MyAbpMultiPageAppControllerBase
    {
